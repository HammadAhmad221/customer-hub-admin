...
// function ClientsTable({onAddNewClient}) {
...
//                 <td className="p-4">{renderPlanBadge(client.tier)}</td>
  ...
  return (
    <>
      ...
      <div className="flex flex-wrap justify-between items-center mb-4">
        <button className="border border-gray-300 p-2 rounded-md shadow-sm mb-3">
          <span>🔍 Filter</span>
        </button>
