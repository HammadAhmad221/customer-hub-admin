...
setIsActive(!isActive)
  ...
  return (
    ...
    <DragAndDropFileUpload />
      ...
      <div>
        <label className="block mb-2 text-gray-700 font-semibold">First Name</label>
        <input
          type="text"
          className="w-full p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500"
      ...
      <div>
        <label className="block mb-2 text-gray-700 font-semibold">Last Name</label>
        <input
          type="text"
          className="w-full p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500"
      ...
      <div>
        <label className="block mb-2 text-gray-700 font-semibold">Website</label>
        <input
          type="text"
          className="w-full p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500"
