...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4 capitalize">
  ...
  <div>
    <label className="block mb-2 text-gray-700 font-semibold">billing address</label>
    <input
      type="text"
      className="w-full p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500"
    ...
    <label className="block mb-2 text-gray-700 font-semibold">late payment date</label>
    <input
      type="text"
      className="w-full p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500"
      placeholder="MM/YY"
  ...
  <div>
    <label className="block mb-2 text-gray-700 font-semibold">next payment due date</label>
    <input
      type="text"
      className="w-full p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500"
      placeholder="MM/YY"
  ...
  <div>
    <label className="block mb-2 text-gray-700 font-semibold">payment status</label>
    <input
      type="text"
      className="w-full p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500"
      placeholder="pending"
