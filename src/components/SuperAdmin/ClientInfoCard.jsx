  ...
  return (
    <div className="sm:w-full md:w-1/4 ">
      ...
      <div className="lg:p-6 p-2 mt-6 md:mt-0 bg-white rounded-lg shadow-lg">
        <h3 className="text-gray-500 text-sm uppercase font-semibold pb-2 border-b">
          Information
        </h3>
        ...
        <div className={`mb-6 ${isPlan ? "hidden" : "block"}`}>
          <h3 className="text-gray-500 text-sm uppercase font-semibold pb-2 border-b border-gray-300 mt-6 text-wrap">
            Internationalization
          </h3>
          <div>
            <label className="block text-md font-bold text-gray-700 mb-1 mt-4">
              Country
            </label>
